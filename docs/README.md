...
Evidence conventions: `round1/*` to `round4/*` are the research lanes and verification passes the documents cite, and `round5/*` holds the independent review and the upstream sweep of 2026-09-24 (for example "V row 2c" is row 2c of `round2/V-verify.md`, "V3 row 2e" is row 2e of `round3/V3-verify.md`, "V4 section 3" is section 3 of `round4/V4-recommendation.md`). `<npm pack>/<name>-<version>/package/...` is a path inside the published npm tarball of that package version. The lane files are pre-verification drafts kept as evidence: the verification files (`round1/07a`, `round1/07b`, `round2/V-verify.md`, `round3/V3-verify.md`, `round4/V4-recommendation.md`) override them, and the documents above are authoritative.
