...
Explanations and options for every decision still open on 2026-09-24. Delete this file when all are decided; the outcomes live in `docs/goals.md` and `docs/scope.md`.
