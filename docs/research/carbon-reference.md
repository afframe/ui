...
- Visual regression per theme: catches theme drift; Carbon uses Chromatic (`chromatic-react` job in `ci.yml`).
...
- Whether `accessibility-checker` 4.0.34 implements IBM checklist 7.3 / WCAG 2.2 rules; Carbon's CI denylist contents.
